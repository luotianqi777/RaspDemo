...
namespace HarmonyLib
{
	...
	public class Traverse
	{
		...
		public object GetValue()
		{
			...
			if (_info is PropertyInfo info1)
				return info1.GetValue(_root, AccessTools.all, null, _params, CultureInfo.CurrentCulture);
			if (_method != null)
		...
		{
			if (_info is FieldInfo info)
				info.SetValue(_root, value, AccessTools.all, null, CultureInfo.CurrentCulture);
			if (_info is PropertyInfo info1)
				info1.SetValue(_root, value, AccessTools.all, null, _params, CultureInfo.CurrentCulture);
			if (_method != null)
		...
		public Type GetValueType()
		{
            ...
            return _info is PropertyInfo info1 ? info1.PropertyType : null;
        }
